...
<head>
    <title>Bijak Mentari Shop - About Us</title>
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row align-items-center py-3">
                <div class="col-md-8 text-white">
                    <h1>About Us</h1>
                    <p>
                        Bijak Mentari (BM) Enterprise is one of the biggest wholesalers and
                        retailers company in GM Klang. This company has been established
                        since 2014. BM is under Exclusive Karangkraf Al-Quran Distributor, who
                        provides wholesale rates for all Muslim & Muslimah Products. We do ship
                        out our customers' orders in instant, as our products are ready in stock.
                        All products we provide are original and high quality products. Other than
                        that, our company allows customers to make orders in bulk, at affordable
                        and low prices. We are operating every day, from 10 am to 6 pm.
                    </p>
                </div>
                <div class="col-md-4">
                    <img src="new-logo.png" alt="About BM">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="container py-5">
        <div class="row text-center pt-5 pb-3">
            <div class="col-lg-6 m-auto">
                ...
                <p>
                    We provide various kind of services just to fulfill your needs.  
                </p>
            </div>
        </div>
        <div class="row">
                ...
                <div class="col-md-12">
                    <div class="testimonial-wrapper">
                        <div class="testimonial-item">
                            <p>Love buying from this shop, I've purchased many times already. Excellent customer service, highly recommended!
                               The designs and colors are very pretty. Material is soft. Highly recommended to others to buy kain pelikat from this shop.
                               Comes with great packaging. 
                            </p>
                            <!--<img src="images/team/team-1.jpg" alt="Testimonial images">-->
                            <h5>Ismail</h5>
                            <div class="desgnation">Lazada's Customer</div>
                        </div>
                        <div class="testimonial-item">
                            <p>Good packaging, I've received the product in good condition. The material is cotton which is very soft to touch and have a silky look.
                               It has nice colours and patterns. Seller is informative when I asked for details and request. Thank you.
                            </p>
                        ...
                        <div class="testimonial-item">
                            <p>Alhamdulillah, safely arrived! Kain elok sangat, design pun lawa. Nasib baik sempat grab design ni sebab stock limited, tak tipu memang tak rugi beli!
                                Worth it! Thank you seller, good service. They delivery is fast, too!
                            </p>
                            <!--<img src="images/team/team-3.jpg" alt="Testimonial images">-->
                            <h5>Mohd</h5>
                            <div class="desgnation">Shopee's Customer</div>
                        </div>
                        <div class="testimonial-item">
                            <p>Received my item with good condition, material is just the same like in the picture. Kain lembut dan ringan, mudah untuk dibawa ke mana-mana.
                                Panjang sejadah sama dengan sejadah bersaiz besar yang biasa digunakan, standard size. The delivery is fast too, thank you seller.
        ...
        <div class="container my-4">
            <div class="row text-center py-3">
                <div class="col-lg-6 m-auto">
                    ...
                    <p>
                        We sell variety of local and imported brands for Muslim daily essentials. We serve our
						customers with best quality materials.
                    </p>
                </div>
                                    ...
                                    <div class="carousel-item active">
                                        <div class="row">
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src="assets/img/8.png" alt="Brand Logo"></a>
                                            </div>
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src="assets/img/gajah-duduk.png" alt="Brand Logo"></a>
                                            </div>
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src="assets/img/karya-bestari.png" alt="Brand Logo"></a>
                                            </div>
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src="assets/img/9.png" alt="Brand Logo"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <!--End First slide-->
            ...
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        ...
                        <li><a class="text-decoration-none" href="#">Kids's Wear</a></li>
                ...
                <div class="col-auto me-auto">
                    <ul class="list-inline text-left footer-icons">
                        <li class="list-inline-item border border-light rounded-circle text-center">
                            <a rel="nofollow" class="text-light text-decoration-none" target="_blank" href="https://www.facebook.com/bijakmentari53/"><i class="fab fa-facebook-f fa-lg fa-fw"></i></a>
                        </li>
                        <li class="list-inline-item border border-light rounded-circle text-center">
