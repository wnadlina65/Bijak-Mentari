        ...
        <div class="col-rt-12">
            ...
            <?php //PHP codes for wholesale form
                    ...
                    if(isset($_POST['login']))
                    {
                        ...
                        $custpassw = $_POST['custpassw'];
                        
                        $sql = "SELECT * FROM customer WHERE custemail = '".$custemail."' AND custpassw = '".$custpassw."'";
                        ...
                        if($row > 0)
                        {
                            ...
                            $_SESSION['custemail'] = $data["custemail"];
                            $_SESSION['custpassw'] = $data["custpassw"];
                            
                            if(($custemail == $data['custemail']) AND ($custpassw == $data['custpassw']))
                            {
                                ?>
                                <!--display a success message, once email sent successfully-->
                                <div class="alert alert-success text-center">
                                    <?php echo "Login success! Welcome to Bijak Mentari Shop."?>
                                </div>
                                <?php
                        ...
                        else
                        {
                            ...
                            <!--display a success message, once email sent successfully-->
                            <div class="alert alert-danger text-center">
                                <?php echo "Failed to process your login request. Please make sure the email/password is correct."?>
                            </div>
                            <?php
                        }
                    }
                ...
                <form class="codehim-form" action="login.php" method="post">
                    ...
                    <input type="text" id="email" name="custemail" class="cm-input" placeholder="Enter your email address" required>
        
                    <label for="pass"><i class="fa fa-lock"></i> Password:</label>
                    <input id="pass" type="password" name="custpassw" class="cm-input" placeholder="Enter your password" required>
                    <button type="submit" name="login" class="btn-login  gr-bg">Login</button>
                    <br>
                    <p class="form__text">
