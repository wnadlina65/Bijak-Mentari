        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="Cover-img/iqra.jpg" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="Iqra/11.png" alt="Product Image 1">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="Iqra/13.png" alt="Product Image 2">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="Iqra/14.png" alt="Product Image 3">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="carousel-item">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="Iqra/7.png" alt="Product Image 4">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="Iqra/inside.png" alt="Product Image 5">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">Buku Iqra' Set Lengkap</h1>
                            <p class="h3 py-2">RM4.28</p>
                            <!--<p class="py-2">
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p>Darul Kitab Sdn Bhd</p>
                                </li>
                            </ul>

                            <h6>Description:</h6>
                            <p>Buku Iqra Set Lengkap (Jilid 1 sehingga Jilid 6)</p>
                            <!--<ul class="list-inline">
                                <li class="list-inline-item">
                            ...
                            <ul class="list-unstyled pb-3">
                                <li>✔ Kandungan buku ini telah disemak oleh penulis.</li>
                                <li>✔ Di sahkan oleh Kementerian Pendidikan Malaysia.</li>
                                <li>✔ Buku Iqra' ini terdiri daripada 6 jilid yang telah diuji di beberapa Sekolah Rendah dan Menengah.</li>
                                <li>✔ Iqra' didapati amat sesuai dan berkesan dan dijadikan sebagai panduan pengajaran di kalangan murid-murid Sekolah Rendah serta pusat pengajian kanak-kanak.</li>
                            </ul>
