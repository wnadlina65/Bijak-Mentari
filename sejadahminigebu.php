        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="Cover-img/sejadah-mini-gebu.png" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="Sejadah-mini-gebu/edited/BM/36.png" alt="Product Image 1">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="Sejadah-mini-gebu/edited/BM/37.png" alt="Product Image 2">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="Sejadah-mini-gebu/edited/BM/38.png" alt="Product Image 3">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="carousel-item">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="Sejadah-mini-gebu/edited/BM/39.png" alt="Product Image 4">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="Sejadah-mini-gebu/edited/BM/4.png" alt="Product Image 5">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="Sejadah-mini-gebu/edited/BM/new edit/red.png" alt="Product Image 6">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">Sejadah Mini Gebu</h1>
                            <p class="h3 py-2">RM9.99</p>
                            <!--<p class="py-2">
                            ...
                            <h6>Description:</h6>
                            <p>Sejadah Mini Gebu Travelling yang diimport dari Turki.</p>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <h6>Avaliable Color :</h6>
                                </li>
                                <li class="list-inline-item">
                                    <p>Premium Silver / Navy Blue / Turquoise / Emerald Green / Red / Dusty Pink</p>
                                </li>
                            </ul>
                            ...
                            <ul class="list-unstyled pb-3">
                                ...
                                <li>✅ Size 35cm by 65cm.</li>
                                <li>✅ Size mini mudah di bawa ke mana-mana sahaja.</li>
                                <li>✅ Lembut, tebal & gebu.</li>
                                <li>✅ Selesa digunakan untuk beribadah.</li>
                                <li>✅ Sesuai untuk dijadikan sebagai hadiah ulang tahun, hantaran, dan saguhati.</li>
                                <li>✅ Mempunyai pilihan warna yang menarik.</li>
                            </ul>
