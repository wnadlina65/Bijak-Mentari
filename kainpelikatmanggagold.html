        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="Cover-img/mangga-gold.jpg" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="MG/2.jpg" alt="Product Image 1">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="MG/3.jpg" alt="Product Image 2">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="MG/4.jpg" alt="Product Image 3">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="carousel-item">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="MG/5.jpg" alt="Product Image 4">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="MG/6.jpg" alt="Product Image 5">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="MG/random.jpg" alt="Product Image 6">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">Kain Pelikat Mangga Gold</h1>
                            <p class="h3 py-2">RM17.99 - RM24.99</p>
                            <!--<p class="py-2">
                            ...
                            <h6>Description:</h6>
                            <p>Kain Pelikat jenama Mangga Gold Kombinasi yang telah siap dijahit.</p>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <h6>Avaliable Color :</h6>
                                </li>
                                <li class="list-inline-item">
                                    <p>Blue / Mint / Grey / Red / Maroon / Brown / Olive Green / Mustard Gold / Green</p>
                                </li>
                            </ul>

                            <h6>Specification:</h6>
                            <ul class="list-unstyled pb-3">
                                <li>✅ Siap jahit, ready to wear.</li>
                                <li>✅ 100 % original.</li>
                                <li>✅ Saiz dewasa.</li>
                                <li>✅ Sangat selesa dipakai.</li>
                                <li>✅ Tidak panas & tidak jarang.</li>
                                <li>✅ Kain cotton yang lembut.</li>
                                <li>✅ Sesuai untuk kegunaan harian.</li>
                                <li>✅ Sesuai dijadikan hadiah atau buah tangan.</li>
                                <li>✅ Terdapat dalam kotak bungkusan yang kemas.</li>
                                <li>✅ Mempuyai pelbagai warna dan corak yang menarik.</li>
                            </ul>
