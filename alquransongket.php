...
<head>
    <title>Bijak Mentari Shop - Product Detail</title>
    <meta charset="utf-8">
        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="Cover-img/AQ-songket-hantaran.jpeg" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="Al-Quran Songket Hantaran/blue.jpg" alt="Blue">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="Al-Quran Songket Hantaran/pink.jpg" alt="Pink">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="Al-Quran Songket Hantaran/purple.jpg" alt="Purple">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="carousel-item">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="Al-Quran Songket Hantaran/yellow.jpg" alt="Yellow">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="Al-Quran Songket Hantaran/random.jpg" alt="Random">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="Al-Quran Songket Hantaran/inside.jpg" alt="Inside">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">Al-Quran Songket Hantaran</h1>
                            <p class="h3 py-2">RM39.00 - RM78.99</p>
                            <!--<p class="py-2">
                            ...
                            <h6>Description:</h6>
                            <p>Al-Quran Songket Hantaran (Saiz A5)</p>
                            <p>Saiz: 15cm x21cm</p>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                ...
                                <li class="list-inline-item">
                                    <p>Yellow / Pink / Blue / Purple</p>
                                </li>
                            </ul>

                            <h6>Specification:</h6>
                            <ul class="list-unstyled pb-3">
                                <li>- Boleh jadikan Al-Quran ini sebagai hadiah hantaran untuk majlis-majlis rasmi ataupun perkahwinan.</li>
                                <li>- Telah disahkan oleh KDN.</li>
                                <li>- Dihiasi dengan corak songket yang premium dan memikat hati.</li>
                                <li>- Kulit cover yang mempunyai ukiran corak yang istimewa.</li>
                                <li>- Cetakan kertas putih dan tidak berwarna.</li>
                                <li>- Mempunyai 4 warna menarik.</li>
                                <li>- Cover seperti songket.</li>
                                <li>- Tak perlu balut dengan kertas lain.</li>
                            </ul>
